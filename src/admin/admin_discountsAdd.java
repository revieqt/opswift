...
public class admin_discountsAdd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Promotion Code");
        ...
        jLabel1.setText("Add Discount/Promotion");
        jPanel1.add(jLabel1);
...
//        type_display.setText((String)type.getSelectedItem());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_discountsAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_discountsAdd().setVisible(true);
            }
        });
    }
