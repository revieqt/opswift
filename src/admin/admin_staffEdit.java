...
public class admin_staffEdit extends javax.swing.JFrame {
    ...
    public void accessTable(TableModel model, int rowid){
        ...
        if((model.getValueAt(rowid, 6).toString()).equals("Administrator")){
            type.setSelectedItem("Administrator");
        }else if((model.getValueAt(rowid, 6).toString()).equals("Cashier")){
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        if(proceed){
            ...
            user.updateUser(id, fname.getText(),lname.getText(), username.getText(), (String)type.getSelectedItem(), (String)status.getSelectedItem());
            this.dispose();
        }
