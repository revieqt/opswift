...
public class admin_customersAdd extends javax.swing.JFrame {
    ...
    public static boolean isValidNumber(String str) {
        // Regular expression to match a string consisting only of 11 digits
        String regex = "\\d{11}";
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        if(fname.getText().isEmpty()|| lname.getText().isEmpty()|| dateFormat.format(bdate.getDate()).isEmpty() || num.getText().isEmpty()|| email.getText().isEmpty()){
            ...
            if(checkData("*","customers","c_num",num.getText())){
                ...
                cus.addCustomer(fname.getText(), lname.getText(), dateFormat.format(bdate.getDate()), Integer.parseInt(age.getText()), num.getText(), email.getText());
                this.dispose();
            }
        }
