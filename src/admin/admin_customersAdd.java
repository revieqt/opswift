...
public class admin_customersAdd extends javax.swing.JFrame {

    public admin_customersAdd() {
        setUndecorated(true);
        initComponents();
    }
        ...
        if(fname.getText().isEmpty()|| lname.getText().isEmpty()|| dateFormat.format(bdate.getDate()).isEmpty() || num.getText().isEmpty()|| email.getText().isEmpty()){
            ...
            if(checkData("*","customers","c_num",num.getText())){
                ...
                error.setText("*Invalid email!");
                 ...
                 error.setText("*Please input an image!");
            }else{
                TableQueries cus = new TableQueries();
                cus.addCustomer(fname.getText(), lname.getText(), dateFormat.format(bdate.getDate()), Integer.parseInt(age.getText()), num.getText(), email.getText(), imp.destination);
                try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_customersAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_customersAdd().setVisible(true);
            }
        });
    }
