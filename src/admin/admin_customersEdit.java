...
import static admin.admin_customersAdd.isValidEmail;
import static admin.admin_customersAdd.isValidNumber;
...
public class admin_customersEdit extends javax.swing.JFrame {
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        if(proceed){
            ...
            cus.updateCustomer(id,fname.getText(),lname.getText(), dateFormat.format(bdate.getDate()), Integer.parseInt(age.getText()), num.getText(), email.getText(), (String)status.getSelectedItem());
            this.dispose();
        }
