...
public class accounting_staff extends javax.swing.JInternalFrame {

    public accounting_staff() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel6.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 220, 130));
        ...
        jPanel6.setBounds(530, 80, 250, 310);
    ...
    private void staff_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_staff_tableMouseClicked
        ...
        TableModel model = staff_table.getModel();
        img.setIcon(imp.ResizeImage(model.getValueAt(choose, 6).toString(), null, img));
        ...
        type_disp.setText(model.getValueAt(choose, 7).toString());
        status_disp.setText(model.getValueAt(choose, 8).toString());
