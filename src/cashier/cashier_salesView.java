...
public class cashier_salesView extends javax.swing.JFrame {

    public int id;
    public cashier_salesView() {
        setUndecorated(true);
        initComponents();
        this.id = id;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cashier_salesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cashier_salesView().setVisible(true);
            }
        });
    }
